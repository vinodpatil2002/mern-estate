    ...
    useEffect(() => {
        ...
        if(searchTermFromUrl || typeFromUrl || offerFromUrl || parkingFromUrl || furnishedFromUrl || sortFromUrl || orderFromUrl){
            setSidebardata({
                ...
                offer: offerFromUrl === 'true' || offerFromUrl === 'false' ? offerFromUrl === 'true' : false,
                parking: parkingFromUrl === 'true' || parkingFromUrl === 'false' ? parkingFromUrl === 'true' : false,
                furnished: furnishedFromUrl === 'true' || furnishedFromUrl === 'false' ? furnishedFromUrl === 'true' : false,
        ...
        <div className="p-7 border-b-2 md:border-r-2 md:min-h-screen">
            <form onSubmit={handleSubmit} className="flex flex-col gap-8">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <select onChange={handleChange} className="border rounded-lg p-3" id="sort_order"
